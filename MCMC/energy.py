...
from mlayer2   import Mlayer, create_mixing_Q, create_mixing_Q_band
...
if True: #longer simulation
    N0      = 100
    L = 2
    Ml      = L*np.array([10, 20, 50])             # layer multipliers
    SigmaL = np.linspace(0.01,0.10,15)
    reps    = 1
    K       = 50
    steps0  = 2*N0
    typeperm = 'asym'
