...
class BenchmarkConfig:
    ...
    problem: str = "bethe"
    L: int = 1
    #Ml: Sequence[int] = (20, 40, 100, 200, 400, 800, 1600)
    #Ml: Sequence[int] = (2 , 10, 20, 40, 100, 150, 200, 300, 400)
    Ml: Sequence[int] = (2 , 10, 20, 40, 100, 200)
    #sigmal: Sequence[float] = tuple(np.linspace(0.01, 0.05, 10))
    sigmal: Sequence[float] = tuple(np.linspace(0.039, 0.041, 2))
    reps: int = 5
    K: int = 50
    steps0: int = 200
    beta: float = 1_000.0
    ...
    #mlayer_backend: str = "long_cycle"                 # induces drift 
